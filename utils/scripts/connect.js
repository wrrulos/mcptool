...
const helpMessage = `
${getSpaces(spaces)}§f§lList of available commands:
...
function createBot(proxy=null) {
    ...
    bot.on('login', () => {
        utils.coloredText(`\n${getSpaces(spaces)}§f§l[§a§l+§f§l] The bot has successfully connected to §a§l127.0.0.1:25565.\n`)
    })
