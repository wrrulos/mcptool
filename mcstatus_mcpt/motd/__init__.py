...
from mcstatus_mcpt.motd.components import Formatting, MinecraftColor, ParsedMotdComponent, TranslationTag, WebColor
from mcstatus_mcpt.motd.simplifies import get_unused_elements
from mcstatus_mcpt.motd.transformers import AnsiTransformer, HtmlTransformer, MinecraftTransformer, PlainTransformer

if t.TYPE_CHECKING:
    from typing_extensions import Self

    from mcstatus_mcpt.status_response import RawJavaResponseMotd, RawJavaResponseMotdWhenDict  # circular import
else:
