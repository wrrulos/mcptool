...
class LocalFileUtilities:
    url_and_paths = [
        ['./mcptool_files/config/bruteforce_config.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/bruteforce_config.json'],
        ['./mcptool_files/config/sendcmd_config.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/sendcmd_config.json'],
        ['./mcptool_files/config/lang/cat.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/cat.json'],
        ['./mcptool_files/config/lang/de.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/de.json'],
        ['./mcptool_files/config/lang/en.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/en.json'],
        ['./mcptool_files/config/lang/es.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/es.json'],
        ['./mcptool_files/config/lang/fr.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/fr.json'],
        ['./mcptool_files/config/lang/pt.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/pt.json'],
        ['./mcptool_files/config/lang/sk.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/sk.json'],
        ['./mcptool_files/config/lang/tr.json', 'https://raw.githubusercontent.com/wrrulos/MCPTool/main/mcptool_files/config/lang/tr.json'],
    ...
    def check_local_files():
        ...
        directories_to_create = [
            './mcptool_files/',
            './mcptool_files/config/',
            './mcptool_files/config/lang/',
        ...
        if not os.path.exists(f'./mcptool_files/config/config.json'):
            data = {
                "lang": "en",
                "api": "mcsrvstat.us",
            ...
            with open(f'./mcptool_files/config/config.json', 'w') as f:
